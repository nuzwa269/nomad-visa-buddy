...
class NVB_Visa_Programs {
	...
	public static function visa_programs_page() {
		// Simple wrapper page - for brevity, reuse countries template structure in future
	...
	public static function save_visa() {
		...
		if ( empty( $_POST['nvb_visa_nonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['nvb_visa_nonce'] ) ), 'nvb_save_visa' ) ) {
		...
		wp_redirect( admin_url( 'admin.php?page=nvb_visa_programs&message=success' ) );
		exit;
	}
}
