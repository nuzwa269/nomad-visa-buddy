...
<div class="wrap nvb-admin-wrap">
	<h1>
		Application Steps
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=nvb_application_steps&action=add' ) ); ?>" class="page-title-action">
			Add New
		</a>
	</h1>
			...
			<?php if ( ! empty( $steps ) ) : ?>
				<?php foreach ( $steps as $st ) : ?>
					<tr>
						...
						<td>
							<a href="<?php echo esc_url( admin_url( 'admin.php?page=nvb_application_steps&action=edit&id=' . intval( $st->id ) ) ); ?>">
								Edit
							</a>
							 |
							<a
