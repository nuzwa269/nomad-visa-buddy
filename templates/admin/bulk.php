...
<div class="wrap nvb-admin-wrap">
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" enctype="multipart/form-data">
		...
		<p>
			<label>Upload CSV (slug,name,continent,currency,flag_url,description):</label><br />
			<input type="file" name="nvb_csv" accept=".csv" />
		</p>
		<p>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<p>
			<button type="submit" class="button">Export Countries CSV</button>
		</p>
	</form>
</div>
